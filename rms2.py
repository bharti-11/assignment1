...
def Price():
    ...
    CostofFries=Label(top, text="Fries=Rs50").grid()
    CostofDrinks=Label(top, text="Drinks=Rs30").grid()
    CostofFilet=Label(top, text="Filet=Rs70").grid()
    CostofBurger=Label(top, text="Burger=Rs30").grid()
    CostofChicken_Burger=Label(top, text="Chicken_Burger=Rs150").grid()
    CostofCheese_Burger=Label(top, text="Cheese_Burger=Rs120").grid()
...
def Ref():
    ...
    CostChicken_Burger=CoChicBurger*150
...
Division=Button(f2,padx=16,pady=16,bd=18,fg="black",font=('arial',20,'bold'),
...
#======================================================Buttons======================================
btnPrice=Button(f1,padx=16,pady=8,bd=16,fg="black",font=('arial',16,'bold'),width=10,
                text="Price",bg="powder blue", command= Price).grid(row=7,column=0) 
